...
namespace Vtt.Identity.Infrastructure.Migrations
{
    ...
    [Migration("20260815111115_InitialIdentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vtt.Identity.Domain.LoginSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTimeOffset?>("PreviousTokenGraceUntil")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Vtt.Identity.Domain.SecurityChallenge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Vtt.Identity.Domain.UserAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTimeOffset?>("DeactivationRequestedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Vtt.Identity.Infrastructure.CredentialRecord", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Vtt.Identity.Infrastructure.EmailOutboxRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("email_outbox", "identity");
                });

            modelBuilder.Entity("Vtt.Identity.Infrastructure.IdentityIntegrationEventRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("integration_outbox", "identity");
                });

            modelBuilder.Entity("Vtt.Identity.Infrastructure.SecurityAuditRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Vtt.Identity.Infrastructure.CredentialRecord", b =>
                {
                    b.HasOne("Vtt.Identity.Domain.UserAccount", null)
                        .WithOne()
                        .HasForeignKey("Vtt.Identity.Infrastructure.CredentialRecord", "UserId")
